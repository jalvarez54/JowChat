...
- [10019] Use provider avatar by default for external login ADD: this function in Profile Change photo.
    ==> done
- [10020] BUG: Photo size in AdminUser/Index
    - ADD: css class .content-user-img
    ==> done
...
- [10006] ADD: Show claims (user and admin mode)
    ...
    ADD: ToList() to IQueriable UserManager.Users ==> UserManager.Users.ToList()
    Why ??
    ==> done
- EXEC: Update-Database in staging
    Update-Database -Script -ConnectionString "data source=192.168.107.232;initial catalog=Cdf54.Ja.SignalR.Chat;Persist Security Info=True;User ID=cdf54projet;Password=p@ssword2014" -ConnectionProviderName System.Data.SqlClient
...
- 2015-05-03 COMMIT: Codeplex jowchat.codeplex.com (107399) PB: Migration folders
...
- [10020] BUG: Photo size in AdminUser/Index
    ...
    ==> done
- [10021] Pseudo, UserName Email usage
    Register form: TextBox UserName is the Pseudo field
        this field is used by Register method as the UserName (must be inchanged)
        var user = new ApplicationUser { UserName = model.Pseudo, Email = model.Email, Pseudo = model.Pseudo };
    Application: In the application I use Pseudo field as "ScreenName".
    Manage: In ManageController/ChangeProfile the user can change his Email (not verified for now) and his Pseudo.
